...
print(clean_email.split("@")[1]) # this extracts the word after @ | university.edu
...
print(reversed_words) #['I', 'evol', 'gninrael', 'nohtyP']
result = " ".join(reversed_words)
print(result) #I evol gninrael nohtyP

#9. Find and Replace Multiple Words
msg = "I like Java and Java is popular"
replace_words = msg.replace("Java", "Python")
print(replace_words) #I like Python and Python is popular
print(replace_words.count("Python")) #2
...
print(result) #Mahesh purchased Laptop for $1450.75
